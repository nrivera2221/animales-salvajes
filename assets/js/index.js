    ...
    animales.forEach((p, i) => {
        animalesTemplate.innerHTML += `
            <div class="px-3 pb-2">
                ...
                />
                <div>
                    <button onclick="playSound('${p.getNombre()}')" class="btn btn-secondary w-100"> <img height="30" src="assets/img/audio.svg" /> </button>
                </div>
                </div>
            </div>
        `;
...
document.getElementById("animal").addEventListener("change", async (e) => {
    ...
    imagenSrc = `./assets/img/${animalObject.imagen}`;
